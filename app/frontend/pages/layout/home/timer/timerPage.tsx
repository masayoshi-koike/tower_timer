...
export default function TimerPage({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full pt-16 sm:pt-4 px-2 sm:px-5 overflow-x-hidden">
      <div className="w-full max-w-7xl grid grid-cols-1 min-[1025px]:grid-cols-12 gap-6 min-[1025px]:gap-1 items-center">
        ...
        <div className="min-[1025px]:col-span-7 flex items-center justify-center w-full px-4 sm:px-0 mt-4 min-[1025px]:mt-0">
          <div className="relative w-full max-w-[360px] min-[1025px]:max-w-[1000px] aspect-square border-2 border-gray-900 overflow-hidden bg-[#ebebe2]">
            {showBreakMode ? (
              <BreakTimeArea
